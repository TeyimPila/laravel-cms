                ...
                <form action="{{route('permissions.store')}}" method="POST">
                    ...
                    <div class="block">
                        <b-radio-group v-model="permissionType">
                            <b-radio name="permission_type" value="basic" selected>Basic Permission</b-radio>
    ...
    <script>
        var app = new Vue({
            ...
            data: {
                ...
                resource: '',
                crudeSelected: ['create', 'read', 'update', 'delete']
            },
            methods: {
                crudName: function (item) {
                    return item.substr(0, 1).toUpperCase() + item.substr(1) + " " + app.resource.substr(0, 1).toUpperCase() + app.resource.substr(1);
                },
                slugName: function (item) {
                    return item.toLowerCase(item) + "-" + app.resource.toLowerCase();
                },
                crudDescription: function () {
